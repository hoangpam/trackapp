...
import com.example.bookingcar.adapter_Customer.AdapterCartItem;
import com.example.bookingcar.adapter_Customer.AdapterProductUser;
        ...
        searchProductEt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try{
                    ...
                    Toasty.info(DriverDetalsActivity.this, "Đang tìm kiếm", Toast.LENGTH_SHORT, true).show();
...
//                }
        ...
        filterProductBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(DriverDetalsActivity.this);
...
//                Intent intent = new Intent(DriverDetalsActivity.this,ShopReviewsActivity.class);
        ...
        checkoutBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(myLAtitude.equals("")||myLAtitude.equals("null")|| myLongitude.equals("null")||myLongitude.equals("")){
                    ...
                    Toasty.error(DriverDetalsActivity.this, "Vui lòng nhập địa chỉ của bạn vào hồ sơ của bạn trước khi đặt hàng", Toast.LENGTH_SHORT,true).show();
                    return;//don't procede further
                }
                if(myPhone.equals("")||myPhone.equals("null")){
                    //user didn't enter phone in profile
                    Toasty.error(DriverDetalsActivity.this, "Vui lòng nhập số diện thoại của bạn vào hồ sơ của bạn trước khi đặt hàng", Toast.LENGTH_SHORT,true).show();
                    return;//don't procede further
                }
                if(cartItemsList.size() == 0){
                    //cart list is empty
                    Toast.makeText(DriverDetalsActivity.this, "Không có mặt hàng nào trong giỏ hàng", Toast.LENGTH_SHORT).show();
        ...
        ref.child(timestamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toasty.success(DriverDetalsActivity.this, "Đã đặt hàng thành công", Toast.LENGTH_SHORT,true).show();


                        //after placing order open order details page
                        //open order details, we need to keys there, orderId, orderTo
                        Intent intent = new Intent(DriverDetalsActivity.this, OrderDetailsUsersActivity.class);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toasty.error(DriverDetalsActivity.this, "Lỗi kìa\n"+e.getMessage(), Toast.LENGTH_SHORT,true).show();
                    }
                });
