...
public class OrderDelivery {
    String AreaLocation,CargoInfo,DeliveryDate,ID,Latitude,Longitude,NameCarInfo,NameLoGoInfo,NameLoInfo,PhoneCus,PhoneDriver,PriceDriverOrder,ProductInfo,RankingTimeInfo,Services,Services1,Services2,Services3,Services4,Status,TotalPrice,UID_Customer,UID_Driver;

    public OrderDelivery() {
    }

    public OrderDelivery(String areaLocation, String cargoInfo, String deliveryDate, String ID, String latitude, String longitude, String nameCarInfo, String nameLoGoInfo, String nameLoInfo, String phoneCus, String phoneDriver, String priceDriverOrder, String productInfo, String rankingTimeInfo, String services, String services1, String services2, String services3, String services4, String status, String totalPrice, String UID_Customer, String UID_Driver) {
