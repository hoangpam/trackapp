...
import com.example.bookingcar.model.OrderDelivery;
...
public class AdapterOrderDelivery extends RecyclerView.Adapter<AdapterOrderDelivery.HolderOrderDelivery> {
    ...
    @NonNull
    @Override
    public AdapterOrderDelivery.HolderOrderDelivery onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //inflare layout
        View view = LayoutInflater.from(context).inflate(R.layout.row_product_booking,parent,false);
        return new AdapterOrderDelivery.HolderOrderDelivery(view);
    }
