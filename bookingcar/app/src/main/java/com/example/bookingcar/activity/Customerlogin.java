...
//            progressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.GREEN));
            ...
            btnBN.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startActivity(new Intent(Customerlogin.this, MainMenu.class));
                    finish();
                }
            });
...
//                                                        Toast.makeText(Cheflogin.this, "Shop đang online", Toast.LENGTH_SHORT).show();
                                        ...
                                        Toasty.success(Customerlogin.this, "Xin chúc mừng! Bạn đã đăng nhập thành công", Toast.LENGTH_SHORT, true).show();
                                        Intent Z = new Intent(Customerlogin.this, CustomerPanel_BottomNavigation.class);
                                        startActivity(Z);
                                        finish();

                                    } else {
                                        ReusableCodeForAll.ShowAlert(Customerlogin.this, "Xác minh không hoàn thành", "Bạn chưa xác minh email của mình. Vui lòng kiểm tra Email");

                                    }
                                } else {
                                    mDialog.dismiss();
                                    ReusableCodeForAll.ShowAlert(Customerlogin.this, "Kết nối của bạn đang bị lỗi", task.getException().getMessage());
                                }
                            }
                        });
                    }
...
//                    letTheUserLoggedIn(v);
            ...
            Toasty.error(Customerlogin.this, "" + e.getMessage(), Toast.LENGTH_SHORT, true).show();
...
//        final MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(context,R.style.MaterialAlertDialog_rounded);
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(Customerlogin.this);
        ...
        builder.setPositiveButton("Xác nhận", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (!Patterns.EMAIL_ADDRESS.matcher(Email).matches()) {
                    Toasty.error(Customerlogin.this, "Cách thức nhập Email của bạn bị sai", Toast.LENGTH_SHORT, true).show();
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toasty.success(Customerlogin.this, "Đã gửi link đặt lại mật khẩu đến Email của bạn", Toast.LENGTH_SHORT, true).show();

//                                    Toast.makeText(Cheflogin.this, "Đã gửi link đặt lại mật khẩu đến Email của bạn", Toast.LENGTH_SHORT).show();
                                } else {
                                    progressDialog.dismiss();
                                    Toasty.error(Customerlogin.this, "Email không tồn tại", Toast.LENGTH_SHORT, true).show();
...
//                                            "Email không tồn tại", Toast.LENGTH_SHORT).show();
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                progressDialog.dismiss();
                                dialog.dismiss();
                                ReusableCodeForAll.ShowAlert(Customerlogin.this, "Lỗi kìa", "Chưa có tài khoản mà đòi quên với chả không");
                                Toasty.error(Customerlogin.this, "" + e.getMessage(), Toast.LENGTH_SHORT, true).show();
                ...
                Fauth.verifyPasswordResetCode(completePhone)
                        .addOnSuccessListener(new OnSuccessListener<String>() {
                            ...
                            public void onSuccess(String s) {
                                Toasty.success(Customerlogin.this, "Oke gần xíu!", Toast.LENGTH_SHORT, true).show();
...
//    Connecttion
    ...
    private boolean isConnected(Customerlogin login) {
