...
public class Driverloginphone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driverloginphone);
        ...
        btnBN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Driverloginphone.this,MainMenu.class));
                finish();
            }
        });
        ...
        sendotp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent b = new Intent(Driverloginphone.this,Driversendotp.class);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Driverloginphone.this,DriverRegistration.class));
                finish();
            }
        });
        signinemail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Driverloginphone.this,Driverlogin.class));
                finish();
            }
        });
