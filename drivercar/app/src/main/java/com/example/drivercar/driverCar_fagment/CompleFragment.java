...
import com.example.drivercar.adapter_Driver.AdapterOrderDeliveryGo;
...
public class CompleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_comple, null);
