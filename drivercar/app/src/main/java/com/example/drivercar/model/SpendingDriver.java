...
public class SpendingDriver {
    String AreaLocation,CargoInfo,ID,Latitude,Longitude,NameCarInfo,NameLoGoInfo,NameLoInfo,PhoneCus,PhoneDriver,PriceDriverOrder,ProductInfo,RankingTimeInfo,Services,Services1,Services2,Services3,Services4,Status,UID_Customer,UID_Driver;

    public SpendingDriver() {
    }

    public SpendingDriver(String areaLocation, String cargoInfo, String ID, String latitude, String longitude, String nameCarInfo, String nameLoGoInfo, String nameLoInfo, String phoneCus, String phoneDriver, String priceDriverOrder, String productInfo, String rankingTimeInfo, String services, String services1, String services2, String services3, String services4, String status, String UID_Customer, String UID_Driver) {
